	...
	extends Taggable
{
  ...
  public int doT1Piecekeyjob(int pieceno, byte[] key);
  
  public int doT1Translatorjob(int pieceno, byte[] key);
  
  public boolean checkT1Piecekey(int pieceno);
  
  public byte[] getT1Piecekey(int pieceno);
