...
public class BTMessageFactory {
  ...
  public static void init() {
    try {
      ...
      //51
      MessageManager.getSingleton().registerMessageType( new BTHandshake( new byte[0], new byte[0], false, MESSAGE_VERSION_INITIAL ));
  ...
  public static Message createBTMessage( DirectByteBuffer stream_payload) throws MessageException {
    ...
    switch( id ) {
      ...
      case 7:
    	// 163
    	Debug.out("Incoming: -> creating BTPiece message");
